...
const BUGS = {
  null_ref: {
    ...
    inject: () => {
      ...
      console.log('FATAL Offending code: add null guard — add null guard — add null guard — add null guard — add null guard — const datapoints = response.MetricDataResults?.[0]?.Values ?? []')
